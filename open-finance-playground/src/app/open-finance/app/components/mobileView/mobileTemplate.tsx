...
segurança para Meu Banco</div>
  ...
  return (
    ...
    <div className={style.mobileContainer} style={{ position: "relative", overflow: "hidden" }}>
      ...
      <LineDotIndicator targetId="todosBancos" color="green" offsetX={12} offsetY={57} side={"right"} hoverText={t('guidelines:listAllInstitutions')} firstHoverDone={firstHoverDone} setFirstHoverDone={setFirstHoverDone}/>
